...
require_once 'stats/stats_query_tot.php';
// Include stats_query_pv file
require_once 'stats/stats_query_pv.php';
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-sm-pull-6" style="padding:20px;">
          ...
          <p style="color:#000000;">
              ...
              <div id="chart-container-tot-ultimoanno">
                ...
                <script type="text/javascript" src="stats/tot_ultimoanno.js"></script>
              </div></p>
          ...
          <p style="color:#000000;">
            <?php
              ...
              <div id="chart-container-tot-questomese">
                ...
                <script type="text/javascript" src="stats/tot_questomese.js"></script>
              </div></p>
          ...
          <p style="color:#000000;">
            ...
            <div id="chart-container-tot-questasettimana">
              ...
              <script type="text/javascript" src="stats/tot_questasettimana.js"></script>
            </div>
          </p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-sm-pull-6" style="padding:20px;">
