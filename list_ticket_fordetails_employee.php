                ...
                echo "<div class=\"table-responsive\">";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<tr>";
                      ...
                      echo "<td><button type=\"button\" class=\"btn btn-warning btn-sm\" onclick=\"location.href='create_report_employee.php?id=".$id_ticket."'\">Scrivi Report ✏ • Visualizza ➡</button></td>";
